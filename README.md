...
- `JHLP_DISABLE_BASH_IDLE_SESSION_TIMEOUT=1` to disable Bash idle sessions to get automatically closed after $BASH_IDLE_SESSION_TIMEOUT. This might be required when using a local Cygwin or WSL or when screen is not being used.
